...
import 'package:safe_hunt/screens/create_group_chat/view/pending_post_screen.dart';
...
class ViewGroupChatScreen extends StatefulWidget {
  ...
  @override
  State<ViewGroupChatScreen> createState() => _ViewGroupChatScreenState();
}

class _ViewGroupChatScreenState extends State<ViewGroupChatScreen> {
  ...
  void _fetchPost(isLoader) {
    GetAllPostBloc().getAllPostBlocMethod(
      ...
      groupId: context.read<PostProvider>().groupDetail?.id ?? '',
      isLoader: isLoader,
      page: _page,
      onSuccess: () {
        _page++;
                    ...
                    showOptionsBottomSheet(
                      ...
                      option: [
                        ...
                        buildOptionTile(
                            ...
                            onTap: () {
                              post.emptyPendingPost();

                              AppNavigation.pop();

                              AppNavigation.push(PendingPostScreen(
                                groupId: post.groupDetail?.id ?? '',
                              ));
                            },
                            context: context)
