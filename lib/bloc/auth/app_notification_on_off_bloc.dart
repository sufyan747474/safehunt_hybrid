...
class AppNotificationOnOffBloc {
  Response? _response;
  VoidCallback? _onSuccess, _onFailure;
  dynamic _formData;

  void appNotificationOnOffBlocMethod({
    ...
    _formData = {
      ...
      "application_notifications_enabled": enableNotificaion
    };
    ...
    await _postRequest(
        endPoint: NetworkStrings.APP_NOTIFICATION_ON_OFF_END_POINT,
        context: context);

    _onSuccess = () {
      Navigator.pop(context);
      _appNotificationOnOffResponseMethod(
          context: context,
          setState: setState,
  ...
  void _appNotificationOnOffResponseMethod({
    required BuildContext context,
    required VoidCallback setState,
    required bool enableNotificaion,
  }) async {
